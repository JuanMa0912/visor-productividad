...
| Proveedores | `/proveedores`, `/proveedores/ingreso/[token]` | `/api/proveedores/visitas`, `/api/proveedores/ingreso`, `/api/proveedores/ventas`, `/api/proveedores/productividad` | Subtablero `proveedores`; pestañas Asistencia (visitas) y QR (links con `proveedores_qr`); ingreso público por sede; ventas 30d + productividad und/kg/tx y volumen÷horas |
