...
| Proveedores | `/proveedores`, `/proveedores/ingreso/[token]` | `/api/proveedores/visitas`, `/api/proveedores/ingreso` | QR público por sede (entrada/salida); tablero admin con filtros/CSV |
