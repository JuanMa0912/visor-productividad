...
| `rotacion/restock-fotos` | GET metadatos o foto base64 + última marca a surtido; PUT foto de item restock ya surtido. En tabla restock, columna **Auditar** (gris sin foto; activa con evidencia) |
