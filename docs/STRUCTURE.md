...
| `rotacion/tendencia` | POST venta diaria `$` de una sede (`empresa`, `sedeId`, `start`, `end`, `items`); modal Tendencia en tabla Rotación. Recorta por A/B/C/D, 0, restock o cero rotación; ignora días de inventario |
