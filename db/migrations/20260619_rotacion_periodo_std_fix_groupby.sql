-- Corrige refresh_rotacion_item_periodo_std: GROUP BY solo (empresa, sede_id, item).
-- Antes agrupaba tambien por linea/descripcion/unidad; si el item cambia de linea
-- en el periodo, generaba filas duplicadas vs PK (empresa, sede_id, item).
