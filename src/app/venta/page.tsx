      ...
      <div className="mx-auto w-full max-w-3xl rounded-3xl border border-slate-200/70 bg-white p-7 shadow-[0_28px_70px_-45px_rgba(15,23,42,0.4)]">
        ...
        <div className="mt-2 flex flex-wrap items-center justify-between gap-3">
          <h1 className="text-2xl font-bold text-slate-900">
            Resultado comercial del negocio
          </h1>
          <button
            type="button"
        ...
        <p className="mt-1 text-sm text-slate-600">
          Usa esta seccion para leer el desempeno comercial, seguir tendencias
          por sede e ingresar a los modulos que explican la venta por item.
        </p>

        <div className="mt-6 grid gap-4 sm:grid-cols-2">
          <button
            type="button"
            onClick={() => router.push("/ventas-x-item")}
            className="rounded-2xl border border-blue-300/80 bg-linear-to-br from-blue-100 via-white to-indigo-100 px-5 py-5 text-left text-slate-900 shadow-[0_18px_35px_-30px_rgba(37,99,235,0.45)] transition-all hover:-translate-y-0.5 hover:border-blue-400"
          >
            ...
            <span className="mt-1 block text-xs text-slate-600">
              Consulta el comportamiento de la venta por item y sede para
              detectar concentraciones, variaciones y participacion comercial.
            </span>
          </button>

          <button
            type="button"
            onClick={() => router.push("/inventario-x-item")}
            className="rounded-2xl border border-blue-300/80 bg-linear-to-br from-blue-100 via-white to-indigo-100 px-5 py-5 text-left text-slate-900 shadow-[0_18px_35px_-30px_rgba(37,99,235,0.45)] transition-all hover:-translate-y-0.5 hover:border-blue-400"
          >
            <span className="inline-flex rounded-full border border-blue-300/80 bg-blue-200/75 px-2.5 py-1 text-[10px] font-bold uppercase tracking-[0.18em] text-blue-800">
              Inventario
            ...
            <span className="mt-1 block text-xs text-slate-600">
              Entra al espacio donde consolidaremos el inventario por
              referencia y su lectura resumida dentro de la seccion de venta.
            </span>
          </button>
        </div>
      </div>
