...
export default function MargenesPage() {
  ...
  useLayoutEffect(() => {
    ...
    setAnchorsReady(
      Boolean(document.getElementById(MARGENES_TOUR_ANCHOR.intro)),
    );
  }, [boardReady, loadingMeta]);
          ...
          >
            <div className="max-w-lg rounded-xl border border-[#2a2f47] bg-[#141720] p-6 shadow-[0_12px_36px_rgba(0,0,0,0.45)]">
              ...
              <ul className="mt-4 space-y-1.5 text-left text-xs text-[#6b7590]">
                <li>
                  · Migración: <span className="font-mono">20260622_margen_final.sql</span>
                </li>
                <li>
                  · Columnas CSV: empresa, fecha_dcto (YYYYMMDD), id_co, id_caja, id_tipo,
                  líneas, ventas, costos, factura
                </li>
                <li>
                  · Legacy <span className="font-mono">margenes_linea_co_dia</span> se
                  mantiene hasta validar carga
                </li>
              </ul>
            </div>
          </main>
