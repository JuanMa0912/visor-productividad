...
# =========================
# FILTROS FRUVER (AJUSTABLES)
# =========================
CATEGORIA = "4"
LINEA1 = "02"  # items.id_linea1

# =========================
# SQL ORIGEN (PARAMETRIZADO)
# IMPORTANTE: 'Z%%' para que el % no choque con placeholders
# =========================
SQL_ORIGEN = """
SELECT
...
CREATE TABLE IF NOT EXISTS {DEST_DB["schema"]}.{DEST_DB["table"]} (
    ...
    CONSTRAINT pk_ventas_carnes PRIMARY KEY (
...
def fetch_origen(cfg: dict, fecha_ini: str, fecha_fin: str) -> pd.DataFrame:
    ...
    try:
        ...
        params = (cfg["empresa"], fecha_ini, fecha_fin, CATEGORIA, LINEA1)
...
def load_destino(df: pd.DataFrame) -> int:
    ...
    text_cols = ["empresa_bd", "centro_operacion", "sede", "caja", "fecha_dcto", "id_tipdoc_fc", "documento_fc",
...
def main():
    ...
    print(f"Consultando | rango={fecha_ini}..{fecha_fin} (America/Bogota) | categoria={CATEGORIA} | linea1={LINEA1}")
